...
*/
$override_title = "Tag : " . ucwords(single_tag_title( '', false )); ?><!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8">
...
$override_title = "Category : ".ucwords(single_tag_title( '', false )); ?>
        <section class="container breadcrumbs-bucket">
          <div class="row">
            <div class="col-md-12">
              <div class="breadcrumbs"><span><a href="/">Home</a></span>
                <div class="separator">»</div><span><?php echo "<a href='$parent_url'>$parent_title</a>"; ?></span>
                <div class="separator">»</div><span>
                  <p><?php if (isset($override_title)) {
	echo $override_title;
}
else {
	the_title();
        ...
        <section class="blog-entries"><?php $paged = ( get_query_var( 'paged' ) ) ? get_query_var( 'paged' ) : 1;
//$query = new WP_Query( array('post_type' => 'post','paged' => $paged) );
if( have_posts() ) {
		while( have_posts() ) {
				the_post(); ?>
          <article><?php echo "<a class='blog-header' href='".get_the_permalink()."'><div class='blog-thumb'>";
...
echo "</div>"; ?>
            <div class="inner">
              <div class="container">
                <div class="row">
                  <div class="col-md-12">
                    <h1 class="blog-title"><?php the_title(); ?></h1><?php echo "<span class='blog-date'>".get_the_date()."</span>"; ?>
                  </div>
                </div>
              </div>
            </div><?php echo "</a>"; ?>
            <div class="container blog-excerpt-row">
              <div class="row">
                <div class="col-md-12">
                  <p>
                    By<?php echo " ".get_author_name(); ?></p>
                  <div class="blog-info">
	...
	echo "</p>";
        ...
        <section class="container pagination">
          <div class="row">
            <div class="col-md-12"><?php $big = 999999999;
