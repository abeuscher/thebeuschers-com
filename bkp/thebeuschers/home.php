    ...
    <body class="loading">
      <div id="wrapper"> 
        ...
        <article class="content home">
          <section class="marquee" data-bg="pic-needle.jpg">
            <div class="container">
              <div class="row">
                <div class="col-md-6"></div>
                <div class="col-md-6">
                  <h1><?php echo get_field("page_headline"); ?></h1>
                  <h2><?php echo get_field("page_tagline"); ?></h2><?php echo "<a class='button cta main' href='".get_field("main_button_target")."'>".get_field("main_button_label")."</a>"; ?>
                </div>
              </div>
            </div>
          </section><?php foreach(get_field("sections") as $key=>$section) {
  echo "<section class='".$section["background_color"]."'>"; ?>
          <div class="container">
            <div class="row"><?php $headers = $section["section_headline"] != "" ? "<h2>".$section["section_headline"]."</h2>" : "";
